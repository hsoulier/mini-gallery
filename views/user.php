<?php foreach ($content as $user): ?>
    ...
    <?php else: ?>
        <button class="btn-new-gallery mt-4 mx-auto block px-6 py-2 text-xs font-medium leading-6 text-center text-white uppercase transition bg-black rounded-full shadow ripple waves-light hover:shadow-lg focus:outline-none hover:bg-black">
            Se connecter
        </button>
    <?php endif; ?>
    <div class="galleries">
